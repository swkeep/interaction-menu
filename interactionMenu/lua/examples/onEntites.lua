...
CreateThread(function()
    ...
    -- local position = vector4(-1999.08, 3177.0, 31.81, 276.06)
    -- Util.spawnObject('m23_1_prop_m31_jammer_01a', position)

    -- position = vector4(-1999.79, 3178.99, 31.81, 290.63)
    -- Util.spawnObject('reh_prop_reh_jammer_01a', position)

    -- position = vector4(-2000.28, 3180.71, 31.81, 294.0)
    -- Util.spawnObject('sm_prop_smug_jammer', position)

    -- position = vector4(-2003.7, 3155.37, 31.81, 275.75)
    -- Util.spawnObject('h4_prop_h4_jammer_01a', position)

    -- position      = vector4(-2005.7, 3160.37, 31.81, 275.75)
    -- ent           = Util.spawnObject('xm_prop_base_tripod_lampa', position)

    -- position      = vector4(-2005.7, 3157.37, 31.81, 275.75)
    -- ent           = Util.spawnObject('xm_prop_base_tower_lampa', position)

    -- position      = vector4(-2003.7, 3157.37, 31.81, 275.75)
    -- ent           = Util.spawnObject('sf_prop_sf_desk_laptop_01a', position)

    -- position      = vector4(-2003.7, 3157.37, 32.565, 275.75)
    -- ent           = Util.spawnObject('xm_prop_x17_laptop_lester_01', position)

    -- local ed      = exports['interactionMenu']:Create {
    --     entity = ent,
    --     maxDistance = 2.0,
    --     options = {
    --         {
    ...
    -- local function retrieve_main(policeData)
    --     local menu = {
    --         {
    --             leave = true
    --         },
    ...
    --     for _, playerInfo in pairs(policeData) do
    --         local subheader = "Grade: " .. playerInfo.grade .. ", Callsign: " .. playerInfo.callsign
    --         menu[#menu + 1] = {
    --             header = "Name: " .. playerInfo.name,
    --             subheader = subheader,
    --             searchable = true,
    --             icon = 'fa fa-user-shield',
    --         }
    ...
    -- RegisterNetEvent("interaction-menu:client:police:set", function(policeData)
    --     retrieve_main(policeData)
    -- end)
end)
